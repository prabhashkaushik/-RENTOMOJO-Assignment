                ...
                <center>
                    <div className="margin-3">
                        <AutoComplete
                            ...
                            fullWidth={true}
                        />
                        <RaisedButton className="margin-31" label={(this.state.sort === "" && "Sort by Score") || (this.state.sort === "asc" && "Sort by Score(High to Low)") || (this.state.sort === "dsc" && "Sort by Score (Low to High)")} primary={true} onClick={this.sortbyscore} />
                    </div>
                </center>
